...
class FEMTA {
  public:
    ...
    FEMTA * initialize(void) {

      // Allocate memory for FEMTA.
      FEMTA * femta = new FEMTA;
      ...
      // GPIOs.
      femta -> gpio_fwd = new MAX7300;
      femta -> gpio_aft = new MAX7300;

      // ADCs
      
      femta -> adc_fwd = AD7490 initialize("fwd", AD7490_CS_FWD);
      femta -> adc_aft = AD7490 initialize("aft", AD7490_CS_AFT);
